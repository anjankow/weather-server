...
// Source: forecast_provider.go
//
// Generated by this command:
//
//	mockgen -source forecast_provider.go -package mock -destination=./../forecast_providers/mock/client.go
//
...
func (m *MockClient) GetDayForecast(ctx context.Context, query domain.DayForecastQuery) (domain.DayForecastRaw, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDayForecast", ctx, query)
	ret0, _ := ret[0].(domain.DayForecastRaw)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
